...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', help='Flag for mcool format input. Default is true. ', default=True)
    ...
    if(mcool):
        ...
        for index, row in sv_df.iterrows():
            ...
            for idx,cur_cool in enumerate(cool_files):
                ...
                target_mtx=c.matrix().fetch(fetching_string)
                # prevent nans in the matrix 
                ...
                col_idx=(idx+1)//3
                im=axes[row_idx-1,col_idx-1].matshow(np.log10(target_mtx), cmap='YlOrRd')
...
# python plot_HiC_graph.py -s /projects/b1042/YueLab/zzhang/ont_pipeline_sample/analysis/target_sv.tsv -c /projects/b1042/YueLab/xtwang/ziyang/SCABER-Arima-allReps-filtered.hg38.mcool -o /projects/b1042/YueLab/zzhang/ont_pipeline_sample/analysis/hiC